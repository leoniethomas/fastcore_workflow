...
for j=1:size(fpkm,2) %for each sample
    ...
    if figflag; figure
        ...
        saveas(gcf,[fig_path ,'histogram_', colnames{j},'.png'])
    end
    ...
    if figflag;figure; hold on
        ...
        saveas(gcf,[fig_path ,'density_', colnames{j},'.png']);
    end
    %% create right curve
    ...
    if figflag; plot(xi,rest_curve, 'r--','LineWidth',2);
        ...
        saveas(gcf,[fig_path ,'density_maxfit_', colnames{j},'.png']);
    end
    %% fit the curves
    ...
    if figflag;
        ...
        saveas(gcf,[fig_path ,'density_fitted_', colnames{j},'.png']);
        close all;
    end
    ...
    if figflag; figure;hold on;
        ...
        saveas(gcf,[fig_path ,'zFPKM_', colnames{j},'.png']);
        close all;
    end
...
if figflag;figure; hold on
    ...
    saveas(gcf,[fig_path ,'density_all.png']);close all
end
...
if figflag;figure; hold on
    ...
    saveas(gcf,[fig_path ,'density_subplots.png']);close all
end
