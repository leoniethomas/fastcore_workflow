function project = modelsComparisonSampling(project,list_model_names,reference_model)
    ...
    samples_model1 = ordered_samples(:,find(sample_model_labels == list_model_names(1)));
    samples_model2 = ordered_samples(:,find(sample_model_labels == list_model_names(2)));
    diff_flux_testing(samples_model1, samples_model2, project.models.(reference_model))
