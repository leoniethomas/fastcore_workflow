function project = singleModelAnalysis(project, parameterTable, modelList, analyses)
...
for i = 1:numel(modelList)
    ...
    % model = project.models.(name).model; % to remove
    % 
    ...
    % 
    % % Setting the objective function - to remove
